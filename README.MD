...
A lightweight [Argos](https://github.com/p-e-w/argos) plugin that scrapes live 2026 Winter Olympics medal counts from Wikipedia and displays them in your GNOME top bar.
